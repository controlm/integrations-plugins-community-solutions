...
#The code below is not needed and left for reference. One is never equal 0
...
echo " Killed IBP execution due to job configured max duration" | tee -a $log_filename
echo "----------------------------------------------------------------------" | tee -a $log_filename
